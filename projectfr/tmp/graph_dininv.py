...
# -*- coding: utf-8 -*-
"""
Created on Mon Jan 18 12:24:54 2021
...
xcurrent = open("xactual_dininv.txt", 'r')
xdesired = open("xdeseado_dininv.txt", 'r') 
qcurrent = open("qactual_dininv.txt",'r')
qdesired = open("qdeseado_dininv.txt",'r')
