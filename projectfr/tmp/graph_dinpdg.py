...
# -*- coding: utf-8 -*-
"""
Created on Mon Jan 18 12:15:35 2021
...
xcurrent = open("xactual_pdg.txt", 'r')
xdesired = open("xdeseado_pdg.txt", 'r') 
qcurrent = open("qactual_pdg.txt",'r')
qdesired = open("qdeseado_pdg.txt",'r')
