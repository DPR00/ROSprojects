...
fqact = open("/home/diegopalma/Documents/ROSProjects/lab_ws/src/frlabs/lab6/tmp/qactual.txt", "w")
fqdes = open("/home/diegopalma/Documents/ROSProjects/lab_ws/src/frlabs/lab6/tmp/qdeseado.txt", "w")
fxact = open("/home/diegopalma/Documents/ROSProjects/lab_ws/src/frlabs/lab6/tmp/xactual.txt", "w")
fxdes = open("/home/diegopalma/Documents/ROSProjects/lab_ws/src/frlabs/lab6/tmp/xdeseado.txt", "w")
...
valores = 0.1*np.array([2.5, 2.5, 1.05, 1.0, 1, 1])
Kp = np.diag(valores)
Kd = 2*np.sqrt(Kp)
g = np.zeros(ndof)
